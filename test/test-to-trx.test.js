require('should');
const testToTrx = require('../lib/test-to-trx');
...
describe('Module test-to-trx', function () {
    ...
    it('should generate correct trx object for passed test', function () {
        const mochaTestMock = {
            title: '1 should be 1',
            fullTitle() { return 'On sample test 1 should be 1'; },
            file: 'testfile.js',
            duration: 1243,
            err: undefined,
            pending: false,
        ...
        const trxTest = testToTrx(mochaTestMock, computerName, process.cwd());
    ...
    it('should generate correct trx object for failed test', function () {
        const mochaTestMock = {
            title: '1 should be 3',
            fullTitle() { return 'On sample test 1 should be 3'; },
            duration: 10000,
            pending: false,
            state: 'failed',
            start: new Date('2015-08-10T00:00:00.000Z'),
