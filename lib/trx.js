 ...
 * Gets filename from:
 *
 * - process arg: --mocha-reporter-file
 * or
...
function getFilename() {
    var argIndex = process.argv.indexOf("--mocha-reporter-file");
    var argFilename = argIndex !== -1 && process.argv[argIndex + 1];

    return argFilename || process.env.MOCHA_REPORT_FILE;
}
